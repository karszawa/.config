...
Constants.ExtensionUserAgentName = "VSTSVSCode";
Constants.ExtensionVersion = "1.136.0";
...
Constants.TfvcLearnMoreUrl = "https://github.com/Microsoft/vsts-vscode/blob/master/TFVC_README.md#quick-start";
Constants.ServerWorkspaceUrl = "https://github.com/Microsoft/vsts-vscode/blob/master/TFVC_README.md#what-is-the-difference-between-a-local-and-server-workspace-how-can-i-tell-which-one-im-working-with";
Constants.VS2015U3CSRUrl = "https://msdn.microsoft.com/en-us/library/mt752379.aspx";
Constants.WorkspaceNotDetectedByClcUrl = "https://github.com/Microsoft/vsts-vscode/blob/master/TFVC_README.md#using-the-tee-clc-i-am-unable-to-access-an-existing-local-workspace-what-can-i-do";
Constants.NonEnuTfExeConfiguredUrl = "https://github.com/Microsoft/vsts-vscode/blob/master/TFVC_README.md#i-received-the-it-appears-you-have-configured-a-non-english-version-of-the-tf-executable-please-ensure-an-english-version-is-properly-configured-error-message-after-configuring-tfexe-how-can-i-get-the-extension-to-work-properly";
