...
Strings.FolderNotOpened = "You must open a repository folder in order to use the Team Services extension.";
...
Strings.NoAccessTokenFound = "A personal access token for this Team Services repository was not found in your local user settings.";
Strings.NoAccessTokenLearnMoreRunSignin = "You are not connected to Team Services (%s). Select 'Learn more...' and then run the 'team signin' command.";
Strings.NoAccessTokenRunSignin = "You are not connected to Team Services (%s). Please run the 'team signin' command.";
...
Strings.NoRepoInformation = "No Team Services or Team Foundation Server repository configuration was found. Ensure you've opened a folder that contains a repository.";
...
Strings.DeviceFlowAuthenticatingToTeamServices = "Authenticating to Team Services (%s)...";
...
Strings.DeviceFlowPlaceholder = "Choose your method of authenticating to Team Services...";
...
Strings.SendFeedback = "Send us feedback about the Team Services extension!";
...
Strings.ProvideAccessToken = "Provide the personal access token for your account";
...
Strings.UnsupportedServerVersion = "The Team Services extension only supports TFS version 2015 Update 2 or later. Please verify your TFS server version.";
...
Strings.UnableToValidateTeamServicesCollection = "Unable to validate the Team Services collection.";
