    ...
    showWelcomeMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._settings.ShowWelcomeMessage) {
                const welcomeMessage = `Welcome to version ${constants_1.Constants.ExtensionVersion} of the Team Services extension!`;
                const messageItems = [];
                messageItems.push({ title: strings_1.Strings.LearnMore,
                ...
                fsw.onDidChange((uri) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (remote === undefined) {
                        ...
                        if (this._repoContext.RemoteUrl !== undefined) {
                            ...
                            logger_1.Logger.LogInfo("remote was removed, previously had a Team Services remote, re-initializing the extension");
                            this.Reinitialize();
                            return;
                        }
                        //There was no previous remote, so do nothing
                        logger_1.Logger.LogInfo("remote does not exist, no previous Team Services remote, nothing to do");
                    }
                        ...
                        if (this._repoContext.RemoteUrl !== undefined) {
                            ...
                            if (remote.toLowerCase() !== this._repoContext.RemoteUrl.toLowerCase()) {
                                ...
                                logger_1.Logger.LogInfo("remote changed to a different Team Services remote, re-initializing the extension");
                                this.Reinitialize();
                            }
                        }
                        else {
                            //The remote was initialized to a Team Services remote, reinitialize
                            logger_1.Logger.LogInfo("remote initialized to a Team Services remote, re-initializing the extension");
                            this.Reinitialize();
                        }
                    }
                }));
